...
type MetaInsertReq struct {
	...
	CategoryId int64 `json:"categoryId" comment:"类别"`
	KingdomId  int64 `json:"kingdomId" comment:"界"`
	PhylumId   int64 `json:"phylumId" comment:"门"`
	ClassId    int64 `json:"classId" comment:"纲"`
	OrderId    int64 `json:"orderId" comment:"目"`
	FamilyId   int64 `json:"familyId" comment:"科"`
	GenusId    int64 `json:"genusId" comment:"属"`
	SpeciesId  int64 `json:"speciesId" comment:"种"`
	common.ControlBy
}
