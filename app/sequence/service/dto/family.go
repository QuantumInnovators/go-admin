...
type FamilyOrder struct {
	...
	NameCn     string `form:"nameCnOrder"  search:"type:order;column:name_cn;table:family"`
	Desc       string `form:"descOrder"  search:"type:order;column:desc;table:family"`
	ParentId   string `form:"parentIdOrder"  search:"type:order;column:parent_id;table:family"`
...
type FamilyInsertReq struct {
	...
	ParentId   int64  `json:"parentId" comment:"所属目"`
