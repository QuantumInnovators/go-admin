...
type OrderOrder struct {
	...
	NameCn     string `form:"nameCnOrder"  search:"type:order;column:name_cn;table:order"`
	Desc       string `form:"descOrder"  search:"type:order;column:desc;table:order"`
	ParentId   string `form:"parentIdOrder"  search:"type:order;column:parent_id;table:order"`
...
type OrderInsertReq struct {
	...
	ParentId   int64  `json:"parentId" comment:"所属纲"`
