...
type GenusOrder struct {
	...
	NameCn     string `form:"nameCnOrder"  search:"type:order;column:name_cn;table:genus"`
	Desc       string `form:"descOrder"  search:"type:order;column:desc;table:genus"`
	ParentId   string `form:"parentIdOrder"  search:"type:order;column:parent_id;table:genus"`
...
type GenusInsertReq struct {
	...
	ParentId   int64  `json:"parentId" comment:"所属科"`
